...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ModernRIBs",
            url:      "https://github.com/MySeconds/ThirdPartyBinaries/releases/download/1.0.5/ModernRIBs.xcframework.zip",
            checksum: "16100ba904e4f417b8d1f78bb638a079d8d613b3269236b0170361ca48247d7b"
        ),
        .binaryTarget(
            name: "SnapKit",
            url:      "https://github.com/MySeconds/ThirdPartyBinaries/releases/download/1.0.5/SnapKit.xcframework.zip",
